...
const AdvertiseCard = ({ product }) => {
  ...
  return (
    <div>
        <div className="card bg-base-100 rounded-2xl shadow-lg mb-10 hover:shadow-2xl h-[80vh] ">
          <figure>
            <img
              src={image}
          ...
          <div className="py-4 px-5">
            <h2 className="card-title justify-between">
              {title}
              <div className="badge badge-black ">SOLD</div>
            </h2>
            ...
            <div className="flex justify-between mt-2 font-semibold ">
              ...
              <p>
                {" "}
                <span className="font-semibold">{used}</span> Years Of Used
              </p>
            </div>
          </div>
          <div className="bg-slate-300 flex py-3 ">
            <div className="mx-auto">
              <p className="border-2 border-black rounded-full px-2 line-through text-sm">
                Market Price: {originalPrice}
              </p>
              <p className="text-4xl font-bold mt-2">{resalePrice}</p>
            </div>
          </div>
          <div className="flex justify-between gap-20 px-5 py-5">
            <div>
            ...
            <div>
              <label
                ...
                className="px-5 py-3 btn-outline hover:bg-black hover:border-black border-4 border-black text-black font-semibold hover:text-white"
              >
                Book Now
              </label>
